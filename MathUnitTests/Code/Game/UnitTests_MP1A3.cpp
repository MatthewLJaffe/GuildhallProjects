...
//-----------------------------------------------------------------------------------------------
bool IsAngleDegreesMostlyEqual( float angleDegreesA, float angleDegreesB )
{
	float angularDisp = angleDegreesB - angleDegreesA;
	...
	return IsMostlyEqual( angularDisp, 0.f, 0.01f );
}
#endif
...
int TestSet_MP1A3_Turning2D()
{
	...
	VerifyTestResult( IsAngleDegreesMostlyEqual( trickyTurn, 1.f ), "GetTurnedToward() incorrect for 723 (or 3) -> 1081 (or 1) degrees, max turn of 3 (should be 1 or 1081 or equivalent)" );
	VerifyTestResult( IsAngleDegreesMostlyEqual( trickyTurn2, 8.f ), "GetTurnedToward() incorrect for -3602 (or -2 or 358) -> 3615 (or 15) degrees, max turn of 10 (should be 8 or -3592 or equivalent)" );
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A3_GeometricQueries2D()
{
#if defined( ENABLE_TestSet_MP1A3_GeometricQueries2D )
...
void RunTests_MP1A3()
{
	printf( "Running tests for MP1-A3 (version 1)...\n" );
	...
	RunTestSet( true, TestSet_MP1A3_GeometricQueries2D,	"MP1-A3: 2D Geometric Queries" );
}
