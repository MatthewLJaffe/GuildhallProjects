...
void App::PrintControlsToConsole()
{
	...
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "W/A\t\t\t\t\tMove");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "S/D\t\t\t\t\tStrafe");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "Q/E\t\t\t\t\tElevate");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "Shift\t\t\tSprint");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "Arrow Keys\t\t\tChange Sun Yaw and Pitch");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "</>\t\t\t\t\tChange Sun Intensity");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "[/]\t\t\t\t\tCycle Scene");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "L\t\t\t\t\t\t\tLoad Model File");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "R\t\t\t\t\t\t\tToggle Model Rotation");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "N\t\t\t\t\t\t\tToggle Debug Models");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "1\t\t\t\t\t\t\tRender Ambient");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "2\t\t\t\t\t\t\tRender Diffuse");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "3\t\t\t\t\t\t\tRender Specular");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "4\t\t\t\t\t\t\tRender Emissive");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "5\t\t\t\t\t\t\tUse Diffuse Map");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "6\t\t\t\t\t\t\tUse Normal Map");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "7\t\t\t\t\t\t\tUse Specular Map");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "8\t\t\t\t\t\t\tUse Glossiness Map");
	g_theDevConsole->AddLine(DevConsole::INFO_MAJOR, "9\t\t\t\t\t\t\tUse Emissive Map");
