...
float StepCompare(float a, float b)
{
	return step(a, b) * step(b, a);
}

float StepCompare(int a, int b)
{
	return StepCompare((float)a, (float)b);
}
...
{
	float output = 0.f;
	output += StepCompare(easingFunciton, 0) * t;
	output += StepCompare(easingFunciton, 1) * SmoothStart2(t);
	output += StepCompare(easingFunciton, 2) * SmoothStart3(t);
	output += StepCompare(easingFunciton, 3) * SmoothStart4(t);
	output += StepCompare(easingFunciton, 4) * SmoothStart5(t);
	output += StepCompare(easingFunciton, 5) * SmoothStart6(t);
	output += StepCompare(easingFunciton, 6) * SmoothStop2(t);
	output += StepCompare(easingFunciton, 7) * SmoothStop3(t);
	output += StepCompare(easingFunciton, 8) * SmoothStop4(t);
	output += StepCompare(easingFunciton, 9) * SmoothStop5(t);
	output += StepCompare(easingFunciton, 10) * SmoothStop6(t);
	output += StepCompare(easingFunciton, 11) * SmoothStep3(t);
	output += StepCompare(easingFunciton, 12) * SmoothStep5(t);
	output += StepCompare(easingFunciton, 13) * Hesitate3(t);
	output += StepCompare(easingFunciton, 14) * Hesitate5(t);
	output += StepCompare(easingFunciton, 15) * (.5f * t + .5f * SmoothStart2(t));
	output += StepCompare(easingFunciton, 16) * (.5f * t + .5f * SmoothStop2(t));
	return output;
}
*/
